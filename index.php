...
<div id="wrapper">
    ...
    <div id="main">
        ...
        <section id="cta" class="main special">
            <form name="schedule" id="schedule" action=<?php echo $_SERVER['PHP_SELF'] ?> method="post">
                <div class="row uniform">
                    <div class="6u 12u$(small)">Start Date: <input
                                data-uk-datepicker="{minDate:'2023-08-29', maxDate:'2024-06-20'}" type=text
                                name='startdate' id='startdate'
                                size=50%
                                value='2023-08-29' tabindex=1></div>
                    <div class="6u$ 12u$(small)">End Date: <input
                                data-uk-datepicker="{minDate:'2023-08-29', maxDate:'2024-06-20'}" type=text
                                name='enddate' id='enddate' size=50%
                                value='2024-06-19' tabindex=2></div>
                </div>
                </br>
            ...
            <p>Currently Supporting Schedules for the 2023-2024 School Year</p>
